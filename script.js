...
const imagenresultado = d.querySelector(".result__img");
const loaderradioactivo = d.querySelector(".loader");
...
textArea.addEventListener("input", (e) => {
  ...
  loaderradioactivo.classList.remove("hidden");
...
botonCopiar.addEventListener('click', ()=>{
    ...
    navigator.clipboard.writeText(textoCopiado).then(()=> {
        ...
        loaderradioactivo.classList.add("hidden");
